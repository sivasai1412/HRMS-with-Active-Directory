...
public class Employee{
	...
	/**
	*This method is used to retrieve the details of the managers and the employees under the particular managers by using their respective employeeID.
	*@param managerId This is the ID of the manager through which we can fetch the details.
	...
	*/
	...
	/**
	*This method is used to retrieve the details of the employees by using their respective employee ID.
	*@param employeeId This is the ID of the contractor through which we can fetch the details.
	*@exception Exception This exception will be used on the Input error.
	*@see Exception 
	*/
	public static void yourDetails(String employeeId) throws Exception{
		...
		for(int i = 0; i < list.getLength(); i++){
			...
			if(employeeId.equalsIgnoreCase(element.getAttribute("Id"))){
				...
				System.out.println();
							Salary s = new Salary();
							System.out.println("\t\t\t\t\t\t\tYour Salary Structure\n\t\t\t\t\t\t~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
	...
	public static String getEmployeeDateDetails() throws Exception{
		...
		while(!webService.publicHolidays(dateOfJoin).equalsIgnoreCase("no")){
			
			//String day = dateOfJoin.substring(0, 2);
			//String month = dateOfJoin.substring(3, 5);
			//String newDate = month+"/"+day+"/"+"2020";
			String holiday = webService.publicHolidays(dateOfJoin);
	...
	/**
	*This method is used to perform the read operations of the employees and managers.
	*@param employeeId This is the ID of the contractor through which we can fetch the details.
	*@exception Exception This exception will be used on the Input error.
	*@see Exception 
	*/
